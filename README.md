...
恒企SEEAI平台前端项目开发的通用vue3应用pc模板([6+通用模板源](https://gitee.com/xccjh-zjh))


## 技术栈
[vue3](https://v3.cn.vuejs.org/)+[typescript](https://www.tslang.cn/)+[ant-design-vue](https://2x.antdv.com/components/overview-cn/)+ [ckeditor5-xccjh](https://gitee.com/xccjh/ckeditor5-xccjh) + [vue3-theme-peel](https://gitee.com/xccjh/vue3-theme-peel) + 
